...
<script type="text/javascript">
	...
	function drawCpuChart() {
		...
		var data = google.visualization.arrayToDataTable([ [ 'CPU', 'Usage' ],
				[ 'idle', 90 ], [ 'used', 10 ] ]);
	...
	function drawDiskChart() {
		...
		var data = google.visualization.arrayToDataTable([ [ 'DISK', 'Usage' ],
				[ 'free', 80 ], [ 'dev1', 20 ] ]);
...
<body>
	<table class="columns">
		<tr>
			<td><div id="cpuchart"
					style="width: 250px; height: 250px; border: 1px solid #ccc"></div></td>
			<td><div id="memorychart"
					style="width: 250px; height: 250px; border: 1px solid #ccc"></div></td>
			<td><div id="diskchart"
					style="width: 250px; height: 250px; border: 1px solid #ccc"></div></td>
		</tr>
